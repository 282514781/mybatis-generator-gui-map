...
public class SelectOneByMapElementGenerator extends AbstractXmlElementGenerator {
    public SelectOneByMapElementGenerator() {
    }

    public void addElements(XmlElement parentElement) {
        XmlElement answer = new XmlElement("select");
        answer.addAttribute(new Attribute("id", "selectOneByMap"));
